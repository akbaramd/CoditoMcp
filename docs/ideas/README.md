...
This directory stores early-stage product and engineering ideas for Codito.

Documents in this directory are exploratory by default. They are not architectural decisions or implementation commitments until they are evaluated and promoted to the appropriate ADR, architecture, research, or implementation documentation.
