...
DATABASE_ASYNC_WORKERS = int(os.getenv("DATABASE_ASYNC_WORKERS", "8"))
if not 2 <= DATABASE_ASYNC_WORKERS <= 32:
    raise ValueError("DATABASE_ASYNC_WORKERS must be between 2 and 32")
REDIS_ASYNC_MAX_CONNECTIONS = int(os.getenv("REDIS_ASYNC_MAX_CONNECTIONS", "64"))
if not 8 <= REDIS_ASYNC_MAX_CONNECTIONS <= 512:
    raise ValueError("REDIS_ASYNC_MAX_CONNECTIONS must be between 8 and 512")
REDIS_ASYNC_POOL_WAIT_SECONDS = float(os.getenv("REDIS_ASYNC_POOL_WAIT_SECONDS", "5"))
if not 0.1 <= REDIS_ASYNC_POOL_WAIT_SECONDS <= 30:
    raise ValueError("REDIS_ASYNC_POOL_WAIT_SECONDS must be between 0.1 and 30")
